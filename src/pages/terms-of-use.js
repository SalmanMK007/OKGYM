...
export default function TermsOfUse() {
  return (
    ...
    >
        ...
        >
            <Grid item mb={4} mt={4}>
                <Typography color="#595959 !important" fontSize="0.9rem" fontFamily="Arial !important">
                    Last updated: August 17, 2022
                </Typography>
            </Grid>
            <Grid item mb={1}>
                <Typography fontFamily="Arial !important" fontSize="19px">
                    AGREEMENT TO TERMS
                </Typography>
            </Grid>
            <Grid
            ...
            >
                <Box mb={2}>
                    ...
                    personally or on behalf of an entity (“you”) and ArtisDAO, a Distributed Autonomous Organization ("DAO", “we”, “us”, or “our”),
                    concerning your access to and use of the <a href="https://www.artis.app">http://www.artis.app</a> website as well as any other media form, media channel,
                    mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use.
            ...
            >
                <Typography fontFamily="Arial !important" fontSize="16px">
                    Use License
                </Typography>
                <Box mb={2}>
            ...
            >
                <Typography color="black" fontFamily="Arial !important" fontSize="16px">
                    Notifications
                </Typography>
                <Box mb={2}>
            ...
            >
                <Box mb={2}>
                    We reserve the right to change, modify, or remove the contents of the Site at any time or for any reason at our sole discretion without notice. However, we have no obligation to update any information on our Site. We also reserve the right to modify or discontinue all or part of the Site without notice at any time. We will not be liable to you or any third party for any modification, price change, suspension, or discontinuance of the Site.                  </Box>
                <Box mb={2}>
            ...
            >
                ...
                <Box mb={2}>
                    If the Parties are unable to resolve a Dispute through informal negotiations, the Dispute (except those Disputes expressly excluded below) will be finally and exclusively resolved through binding arbitration. YOU UNDERSTAND THAT WITHOUT THIS PROVISION, YOU WOULD HAVE THE RIGHT TO SUE IN COURT AND HAVE A JURY TRIAL. The arbitrator must follow applicable law, and any award may be challenged if the arbitrator fails to do so. Except as otherwise provided herein, the Parties may litigate in court to compel arbitration, stay proceedings pending arbitration, or to confirm, modify, vacate, or enter judgment on the award entered by the arbitrator.
                </Box>
                <Box mb={2}>
                    If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in Switzerland and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction, and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) is excluded from these Terms of Use.
                </Box>
                <Box mb={2}>
            ...
            >
                <Box mb={2}>
                    There may be information on the Site that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Site at any time, without prior notice. We reserve the right to refuse to offer any product or service to anyone for any reason.
                </Box>
            </Grid>
            <Grid item mb={1}>
                <Typography fontFamily="Arial !important" fontSize="19px">
